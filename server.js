...
// Routes
// =============================================================
var routes = require("./routes/burger-routes.js"); //define routes variable as calls from burger-routes.js

// connect the routes
app.use('/', routes); //set / directory route (uses findAll sequelize method)
app.use('/update/:id', routes); //set /update route (uses update)
app.use('/create', routes); //set /create route (uses create)
